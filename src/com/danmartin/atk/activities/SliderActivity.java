...
public class SliderActivity extends Activity implements SeekBar.OnSeekBarChangeListener {
    ...
    public final ArrayList<String> lock = new ArrayList<String>();
...
//        UsbManager manager = UsbManager.getInstance(this);
    ...
    private void openAccessory() {
        ...
        if (mFileDescriptor != null) {
            ...
            CommThread thread = new CommThread("CommThread");
            thread.start();
        }
    }
...
//                }
        ...
        protected void communicate() {
            synchronized (SliderActivity.this.lock) {
                while (true) {
                    ...
                    try {
                        while (mChangeMade) {
                            ...
                            if (result == request) { // wait for confirmation (request was sent)
                                ...
                                if (inRequest.queue(bufferIn, 8) == true) {
